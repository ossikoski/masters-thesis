...
\documentclass[english, numeric, draft]{tauthesis}  % draft -> kuvat ei lataudu
...
% separate line.
\examiner[Examiner]{Tarkastajan nimi}
...
\programmename{Master's Programme in Automation Engineering}{Automaatiotekniikan DI-ohjelma}
